...
kiwi.Settings = Backbone.Model.extend({
    ...
    fetch: function () {
        if (typeof this.storage === 'object' || this.storage instanceof Storage) {
            var settings = this.storage.getItem('kiwi.settings');
    ...
    sync: function (settings) {
        ...
        this.storage.setItem('kiwi.settings', JSON.stringify({
            authorName: this.authorName,
            authorAddress: this.authorAddress,
            loginType: this.loginType,
            searchOnTag: this.searchOnTag,
...
kiwi.SettingsView = Backbone.View.extend({
    ...
    render: function() {
        ...
        $('.searchOnAttachmentName', el).attr('checked',
                settings.searchOnAttachmentName);
    ...
    _bindModelChange: function(settings, el) {
        ...
        settings.on('change:searchOnAttachmentName',
                onChangeSearchOnAttachmentName);
        ...
        this._unbindModelChange = function() {
            ...
            settings.off('change:searchOnAttachmentName',
                    onChangeSearchOnAttachmentName);
